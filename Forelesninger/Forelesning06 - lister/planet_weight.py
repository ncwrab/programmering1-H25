...
if din_vekt.isnumeric() == True:
    ...
    print("OK")
# Har man derimot brukt andre tegn, slik som bokstaver eller andre tegn, gir programmet en feilmelding og avsluttes
else:
...
# Utregning for å finne brukerens vekt på den oppgitte planeten:
