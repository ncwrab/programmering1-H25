...
# Ber brukeren skrive inn sin vekt. Her gjøres vekten om til desimaltall i en separat operasjon på linjen under.
din_vekt = input("Hva er din vekt på Jorden (i kg)")
din_vekt = float(din_vekt)

# Beregninger for å regne ut vekten på valgt planet. Merk at tyngdekraft[2] er inneholder jordens tyngdekraft.
vekt_paa_planet= din_vekt / tyngdekraft[2] * tyngdekraft[planetnummer]
